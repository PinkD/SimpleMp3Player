...
public class CharParser {
   ...
   /* private StringBuilder buffer;
    ...
    private static CharParser charParser = new CharParser();

    public static CharParser getInstance() {
        return charParser;
    }
...
*/
    ...
    /** * 词组解析 * * @param resourse * @return */
    public static String getSpelling(String resourse) {
        StringBuilder buffer;
        String key, value;
        buffer = new StringBuilder();
        for (int i = 0; i < resourse.length(); i++) {
            key = resourse.substring(i, i + 1);
